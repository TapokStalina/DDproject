...
namespace Api.Migrations
{
    ...
    [Migration("20221122125316_Subscribes")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DAL.Entities.LikeOnComment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("LikesOnComment");
                });

            modelBuilder.Entity("DAL.Entities.LikeOnPost", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("DAL.Entities.Subscribe", b =>
                {
                    ...
                    b.Property<Guid>("SubscribeOwnerId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("DAL.Entities.CommentContent", b =>
                {
                    ...
                    b.ToTable("CommentContent", (string)null);
                });
            ...
            modelBuilder.Entity("DAL.Entities.CommentContent", b =>
                {
                    b.HasOne("DAL.Entities.Comment", null)
                        .WithOne()
                        .HasForeignKey("DAL.Entities.CommentContent", "CommentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
